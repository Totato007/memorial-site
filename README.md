...
| 好友系统 | 多人关系网络，好友申请制，情侣(限1)/好友/家人/自定义，在线状态 |
| 消息中心 | 三标签分类 — 最近消息 / 好友申请 / 我的申请，待处理计数 |
| 可见权限 | 四级 — 仅自己 / 仅情侣 / 仅好友 / 公开 |
| 心情日记 | 心情 + 文字 + 图片，可见范围选择，按月筛选 |
| 公共广场 | 展示全站用户公开分享的日记 |
| 未来计划 | CRUD + 分类筛选 + 状态切换 + 可见范围 |
| 互动聊天 | 好友卡片一键聊天，文字 + 压缩图片，3 秒实时轮询 |
...
| 页面 | URL | 说明 |
|---|---|---|
| 首页仪表盘 | `/dashboard` | 好友卡片 + 在线状态 + 一键聊天 |
| 好友列表 | `/friends` | 按类型分组，直接聊天按钮 |
| 添加好友 | `/friends/add` | 搜索用户，发送申请 |
| 消息中心 | `/notifications` | 最近消息/好友申请/我的申请 |
| 好友详情 | `/friends/:id` | 相处天数、纪念日、发消息 |
| 互动聊天 | `/chat` 或 `/chat?with=:id` | 选择好友对话，实时轮询 |
| 心情日记 | `/diary` | 写日记，选可见范围 |
| 公共广场 | `/public` | 浏览全站公开日记 |
| 未来计划 | `/plans` | 创建计划，可见范围 |
